...
def main(
    ...
    sv_report_cols = (
        ...
        + [
            ...
            "N_UNIQUE_HPO_TERMS",
            "N_GENES_IN_OMIM",
            "Canadian_MSSNG_parent_SVs.Manta_nativehg38",
            "Canadian_MSSNG_parent_SVs.Manta_nativehg38_SV",
            "Canadian_MSSNG_parent_SVs.Lumpy_liftedhg38",
            "Canadian_MSSNG_parent_SVs.Lumpy_liftedhg38_SV",
            "DGV_GAIN_IDs",
