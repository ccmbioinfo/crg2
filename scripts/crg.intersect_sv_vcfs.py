...
def main(
    ...
    sv_report_cols = (
        ...
        + [
            ...
            "N_UNIQUE_HPO_TERMS",
            "N_GENES_IN_OMIM",
            "noBNDs_includeHQsamples_mssngSubjetsCounts_hiseqX_mantaSVs_db6_hg38_1based_FIXEDCOLUMNS_sorted_nochr_uppertype",
            "noBNDs_includeHQsamples_mssngSubjetsCounts_hiseqX_mantaSVs_db6_hg38_1based_FIXEDCOLUMNS_sorted_nochr_uppertype_SV",
            "Canadian_MSSNG_parent_SVs.LUMPY_hg38_counts_LIFTED_sorted",
            "Canadian_MSSNG_parent_SVs.LUMPY_hg38_counts_LIFTED_sorted_SV",
            "DGV_GAIN_IDs",
