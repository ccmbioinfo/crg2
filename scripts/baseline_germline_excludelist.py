...
baseline_samples = snakemake.params.baseline_samples
baseline_vcf_samples = [f"{family}_{sample}" for sample in baseline_samples]
...
for record in vcf_in:
    ...
    for sample in baseline_vcf_samples:
