...
$mc mb minio/results-c4r/deep_exome_seq/$family
...
if [ "$NGS_type" == wgs ]; then
	...
	$mc cp ${family_dir}/report/coding/${family}/${family}.clinical.wes.regular*csv minio/results-c4r/deep_exome_seq/$family
	$mc cp ${family_dir}/report/coding/${family}/${family}.clinical.wes.synonymous*csv minio/results-c4r/deep_exome_seq/$family
	$mc cp ${family_dir}/report/coding/${family}/${family}.wes.regular*csv minio/results-c4r/deep_exome_seq/$family
	$mc cp ${family_dir}/report/coding/${family}/${family}.wes.synonymous*csv minio/results-c4r/deep_exome_seq/$family
fi
	
if [ "$multiqc" == multiqc ]; then
	$mc cp ${family_dir}/qc/multiqc/multiqc.html minio/results-c4r/deep_exome_seq/$family
fi
...
if [[ "$coverages" == coverages ]]; then
   ...
   for direc in ${family_dir}/${family}_*_coverages
     ...
     $mc mb minio/results-c4r/deep_exome_seq/$family/$sample_cov
     $mc cp ${direc}/${family}*.dedup.bam.coverage_stats.csv minio/results-c4r/deep_exome_seq/$family/$sample_cov
     $mc cp ${direc}/${family}*.dedup.bam.less20x_coverage.csv minio/results-c4r/deep_exome_seq/$family/$sample_cov
     $mc cp ${direc}/${family}*.dedup.bam.less20x.stats.csv minio/results-c4r/deep_exome_seq/$family/$sample_cov
     $mc cp ${direc}/${family}*.dedup.bam.median minio/results-c4r/deep_exome_seq/$family/$sample_cov
     $mc cp ${direc}/${family}*.dedup.bam.per_exon.csv minio/results-c4r/deep_exome_seq/$family/$sample_cov
     $mc cp ${direc}/${family}*.dedup.bam.per_exon.distribution.csv minio/results-c4r/deep_exome_seq/$family/$sample_cov
     done
fi
